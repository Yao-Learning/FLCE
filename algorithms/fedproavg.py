...
from tools import cal_client_full_contri
...
class FedproAvg():
    ...
    def train(self):
        ...
        for r in range(1, self.args.max_round + 1):
            ...
            preclients_features = [[] for i in range(self.args.n_clients)]
            ...
            for client in sam_clients:
                ...
                preclient_classmean, preclient_classnum = preprototype(self, copy.deepcopy(self.model), self.train_loaders[client], self.test_loaders[client])
                ...
                preclients_features[client] = preclient_classmean
            ...
            all_similarities = client_similarity_P(preclients_features, clients_features, clients_class_num, self.args.n_classes, self.args.n_clients, r)
            ...
            if r % self.args.test_round == 0:
                # global test loader
                glo_test_acc, glo_test_precision, glo_test_recall, glo_test_f1, glo_test_auc = self.test(
                    model=self.model,
                    loader=self.glo_test_loader,
                )
                print('第{}轮的globe acc为{}'.format(r, glo_test_acc))
                ...
                print("[R:{}] [Ls:{}] [TeAc:{}] [PAcBeg:{} PAcAft:{}] [pre: {}] [recall: {}] [f1_score: {}] [AUC: {}]".format(
                    r, train_loss, glo_test_acc, per_accs[0], per_accs[-1], glo_test_precision, glo_test_recall, glo_test_f1, glo_test_auc
                ))
